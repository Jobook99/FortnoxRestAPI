...
public class BoxesFacadeREST extends AbstractFacade<Boxes> {
    ...
    @Path("{id}")
    @Consumes({"application/xml", "application/json"})
    public void edit(@PathParam("id") Integer id, Boxes entity) {
        super.edit(entity);
    }
    ...
    public Boxes find(@PathParam("id") Integer id) {
    ...
    @Path("{from}/{to}")
    @Produces({"application/xml", "application/json"})
    public List<Boxes> findRange(@PathParam("from") Integer from, @PathParam("to") Integer to) {
